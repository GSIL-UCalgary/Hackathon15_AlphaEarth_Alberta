...
class ImageHyperConnectionTransformer_mhc(nn.Module):
    ...
    def forward(self, x: torch.Tensor, gt_Map=None, epoch=None, return_features=False):
        ...
        # (B, dim, H/P, W/P)
        upsampled_h_final = self.upsampling(h_final)
        # (B, dim, H, W)
        logits = self.cls_head(upsampled_h_final)
        # (B, num_classes, H, W)
        #pdb.set_trace()
        Y.append(logits)
