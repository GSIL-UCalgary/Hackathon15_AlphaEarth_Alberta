# THis code was downlaoded from the officially published HRNet model
...
# Use standard BatchNorm2d instead of synchronized version for simplicity
...
class HighResolutionNet(nn.Module):
    ...
    def forward(self, x):
        ...
        # Add final upsampling to match input size
        x = F.interpolate(x, size=original_size, mode='bilinear', align_corners=ALIGN_CORNERS)
...
# HRNet Wrapper for your YAML config format
